...
namespace AmplifyBloom
{
	public class DemoMainUI : MonoBehaviour
	{
		...
		public Dropdown ThresholdSizeDropdown;
		...
		void Awake()
		{
			...
			ThresholdSizeDropdown.onValueChanged.AddListener( OnThresholdSize );
			ThresholdSizeDropdown.value = ( int ) _amplifyBloomEffect.MainThresholdSize;
			if ( Input.GetJoystickNames().Length > 0 )
			{
				...
				m_uiElements[ 12 ] = ThresholdSizeDropdown.GetComponent<DemoUIElement>();
		...
		public void OnThresholdSize( int selection )
		{
